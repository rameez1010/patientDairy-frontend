  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        <h1 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black mb-3 text-text-light dark:text-text-dark tracking-tight leading-tight">Create Doctor Account</h1>
        <p className="text-lg text-muted-light dark:text-muted-dark">Please provide your professional credentials.</p>
      </div>

      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block mb-2 font-bold text-sm text-text-light dark:text-text-dark">First Name</label>
            <input 
              name="firstName" 
              placeholder="Dr. Jane" 
          ...
          <div>
            <label className="block mb-2 font-bold text-sm text-text-light dark:text-text-dark">Last Name</label>
            <input 
              name="lastName" 
              placeholder="Smith" 
              value={form.lastName} 
        ...
        <div>
          <label className="block mb-2 font-bold text-sm text-text-light dark:text-text-dark">Password</label>
      ...
      <div className="text-center mt-8 text-sm text-text-light dark:text-text-dark">
        Already have an account? <Link to="/login" className="text-primary font-bold hover:underline">Login page</Link>
      </div>
    </motion.div>
  );
};
